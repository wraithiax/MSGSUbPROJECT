...
@section('content')
    ...
    <form action="{{ route('maintenance.store') }}" method="POST" style="max-width: 700px;">
        @csrf
        ...
        <div style="background: #fff; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(236, 72, 153, 0.15);">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea name="description" 
                          ...
                          onfocus="this.style.borderColor='#ec4899';"
                          onblur="this.style.borderColor='#fce7f3';">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <select name="maintenance_type" 
                        ...
                        <option value="system" {{ old('maintenance_type') === 'system' ? 'selected' : '' }}>System</option>
                        <option value="database" {{ old('maintenance_type') === 'database' ? 'selected' : '' }}>Database</option>
                        <option value="infrastructure" {{ old('maintenance_type') === 'infrastructure' ? 'selected' : '' }}>Infrastructure</option>
                        <option value="security" {{ old('maintenance_type') === 'security' ? 'selected' : '' }}>Security</option>
